...
class UserInfosControllerTest < ActionController::TestCase
  ...
  test "should create user_info" do
    assert_difference('UserInfo.count') do
      post :create, user_info: { city: @user_info.city, first_name: @user_info.first_name, last_name: @user_info.last_name, phone: @user_info.phone, state: @user_info.state, user_id: @user_info.user_id }
    end
  ...
  test "should update user_info" do
    patch :update, id: @user_info, user_info: { city: @user_info.city, first_name: @user_info.first_name, last_name: @user_info.last_name, phone: @user_info.phone, state: @user_info.state, user_id: @user_info.user_id }
    assert_redirected_to user_info_path(assigns(:user_info))
  end
